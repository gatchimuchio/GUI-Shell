...
| Desktop Flutter Linux build | failed | release_blocker | yes | `cd apps/desktop_flutter && flutter build linux` fails with: `No Linux desktop project configured.` | Add Linux desktop project support for `apps/desktop_flutter`, then pass `flutter build linux`. |
