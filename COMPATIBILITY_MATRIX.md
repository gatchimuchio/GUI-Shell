...
| Desktop Flutter Linux launch | not_passed | release_blocker | yes | The built Linux desktop artifact has not yet been launched and first-window startup evidence has not been recorded. | Launch `build/linux/x64/release/bundle/gui_shell_desktop` and record startup evidence. |
